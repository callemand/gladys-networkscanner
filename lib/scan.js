...
/*
                getOrCreateDevice(name, identifier)
                .then((device) => {
...
*/
        ...
        .then((data) => {
            ...
            for (var i = 0, len = data.length; i < len; i++) {
                identifierFounded[data[i].identifier] = true;
            }
            sails.log.debug('List Identifier');
